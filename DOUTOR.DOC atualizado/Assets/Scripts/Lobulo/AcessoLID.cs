    ...
    void Update()
    {
        if (mouseDentroDoObjeto == true)
        {
            if(LobuloLID != null)
            {
                ...
                {
                    if ((kaypadSD.gameObject.activeSelf) || (kaypadSE.gameObject.activeSelf) || (kaypadIE.gameObject.activeSelf) || (kaypadC.gameObject.activeSelf) || (manualCovid.gameObject.activeSelf))
                    {
